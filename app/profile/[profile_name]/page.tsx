...
export default function Profile({ params }: Username) {
  ...
  const favoriteMovieObj = userProfileData.favMovies.results;
  const favMovieList = userProfileData.userDetails.userExists.favorite_movies;
  ...
  return (
    <div className="h-screen relative">
      ...
      <div className="relative bg-gray-900 h-5/6  flex flex-row justify-center">
        {favoriteMovies}
      </div>
