...
const quotesData: { [key: string]: { quote: string; director: string } } = {
  ...
  "11": {
    quote:
      "Never give up. If you want to become one, you have to be really, really strong, never give up, because you’re going to have so many ‘nos.’ When I wrote my first screenplay I was 17, but when I directed my first film I was 36. It gives you an idea how long it takes.",
